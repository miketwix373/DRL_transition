...
$(./src/solver.f90) += $(mod_common_mpi.mod)
$(./src/solver.f90) += $(mod_param.mod)
$(./src/utils.f90) += $(mod_common_mpi.mod)
...
$(./src/lbl.f90) += $(mod_common_mpi.mod)
...
$(./src/drl.f90) += $(mod_types.mod)
$(./src/sanity.f90) += $(mod_correc.mod)
$(./src/drl.f90) += $(mod_common_mpi.mod)
$(./src/drl.f90) += $(mpi.mod)
$(./src/drl.f90) += $(mod_utils.mod)
...
$(./src/scal.f90) += $(mod_common_mpi.mod)
...
$(./src/bound.f90) += $(mod_param.mod)
$(./src/bound.f90) += $(mod_drl.mod)
...
$(./src/timer.f90) += $(mod_common_mpi.mod)
$(./src/timer.f90) += $(mod_nvtx.mod)
$(./src/updatep.f90) += $(mod_types.mod)
$(./src/lbl.f90) += $(mod_types.mod)
$(./src/lbl.f90) += $(mod_utils.mod)
